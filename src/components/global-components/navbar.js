			...
			<div className="ltn__header-top-area section-bg-6 top-area-color-white---">
				...
				<div className="row">
					...
					<div className="ltn__top-bar-menu">
						<ul>
						<li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i className="icon-mail" /> filestrader@gmail.com</a></li>
						<li><a href="locations.html"><i className="icon-placeholder" /> Offcie 3, Plaza 9, Jinah boulevard, Sector 9 DHA 2, ISLAMABAD</a></li>
						</ul>
					</div>
					</div>
							...
							<li className="menu-icon"><Link to="#">Pages</Link>
								<ul className="mega-menu">
									...
									<li><Link to="#">Shop Pages</Link>
										<ul>
											<li><Link to="/shop">Shop</Link></li>
											<li><Link to="/shop-left-sidebar">Lahore</Link></li>
											<li><Link to="/shop-right-sidebar">Shop right sidebar</Link></li>
											<li><Link to="/shop-grid">Shop Grid</Link></li>
											<li><Link to="/product-details">Shop details </Link></li>
											<li><Link to="/cart">Cart</Link></li>

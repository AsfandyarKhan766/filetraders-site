              ...
              <div className="ltn__faq-inner ltn__faq-inner-2">
                    ...
                    <div id="faq-item-2-1" className="collapse" data-bs-parent="#accordion_2">
                      <div className="card-body">
                        <p>
                          ...
                          Scelerisque eleifend donec pretium vulputate sapien nec sagittis. Proin libero nunc consequat interdum. Condimentum lacinia
                          quis vel eros donec ac. Mauris sit amet massa vitae tortor. Quisque id diam vel quam elementum pulvinar. Gravida in
                          fermentum et sollicitudin ac orci phasellus. Facilisis gravida neque convallis a cras semper. Non arcu risus quis varius
                          quam quisque id.
                        </p>
                      </div>
                    </div>
                ...
                <div className="need-support text-center mt-100">
                  ...
                  <div className="btn-wrapper mb-30 go-top">
                    <a className="theme-btn-1 btn" href="tel:+923313388811">
                      CALL NOW
                    </a>
                  </div>
                  <h3>
                    <i className="fas fa-phone" /> +92 331 3388811
                  </h3>
                </div>
              </div>
            </div>

                ...
                <div className="row">
                    ...
                    <div className="ltn__appointment-inner">
                        ...
                        <div className="row">
                            ...
                            <div className="input-item input-item-name ltn__custom-icon">
                                <input type="text" name="ltn__name" placeholder="Price in pkr (only numbers)" />
                            </div>
                            </div>
                            <div className="col-md-6">
                            <div className="input-item input-item-name ltn__custom-icon">
                        ...
                        <div className="btn-wrapper text-center mt-30">
                            <button className="btn theme-btn-1 btn-effect-1 text-uppercase" type="submit">Submit File</button>
                        </div>
                        </form>
                    </div>
                    </div>

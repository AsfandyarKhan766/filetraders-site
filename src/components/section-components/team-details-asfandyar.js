...
class TeamDetailsAsfandyar extends Component {
  render() {
            ...
            <div className="col-lg-4">
              <div className="ltn__team-details-member-info text-center mb-40">
                <div className="team-details-img">
                  <img src={publicUrl + "assets/img/team/asfandyar.jpg"} alt="Team Member Image" />
                </div>
                <h2>Asfandyar</h2>
            ...
            <div className="col-lg-8">
              <div className="ltn__team-details-member-info-details">
                  ...
                  <div className="col-lg-6">
                    <div className="ltn__team-details-member-about">
                      <ul>
                        ...
                        {/* <li><strong>Fax:</strong> +92 331 3388811</li> */}
                        <li>
                          <strong>Phone:</strong>+92 331 3388811
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <p>
                  ...
                  explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequu ntur magni dolores eos qui
...
export default TeamDetailsAsfandyar;

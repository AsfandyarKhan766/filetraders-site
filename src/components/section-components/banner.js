				            ...
				            <div className="col-lg-12 align-self-center">
				              <div className="slide-item-info">
				                <div className="slide-item-info-inner ltn__slide-animation">
				                  ...
				                  <h6 className="slide-sub-title white-color--- animated"><span><i className="fas fa-home" /></span> Files Tradering Company</h6>
				                  <h1 className="slide-title animated ">Let's Trade <br /> With Us</h1>
				                  <div className="slide-brief animated">
				                    <p>We deals in all type of files in all over pakistan</p>
				                  </div>
				                  <div className="btn-wrapper animated ">
				                    	<Link to="/about" className="theme-btn-1 btn btn-effect-1 go-top">Our description video</Link>

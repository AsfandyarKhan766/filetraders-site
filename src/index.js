...
import ShopBahria from "./components/shop-bahria";
import ShopMetro from "./components/shop-metro-city";
import ShopParkView from "./components/shop-park-view";
import ShopTopCity from "./components/shop-top-city";
      ...
      <HashRouter basename="/">
        <div>
          <Switch>
            ...
            <Route path="/shop-metro" component={ShopMetro} />
            <Route path="/shop-bahria" component={ShopBahria} />
            <Route path="/shop-park-view" component={ShopParkView} />
            <Route path="/shop-top-city" component={ShopTopCity} />

            <Route path="/shop-grid" component={ShopGrid} />
            <Route path="/shop-left-sidebar" component={ShopLeftSidebar} />
            <Route path="/shop-right-sidebar" component={ShopRightSidebar} />
            <Route path="/shop-right-sidebar-metro" component={ShopRightSidebar} />
            <Route path="/shop-right-sidebar-bahria" component={ShopRightSidebar} />
            <Route path="/shop-right-sidebar-park-view" component={ShopRightSidebar} />
            <Route path="/shop-right-sidebar-top-city" component={ShopRightSidebar} />
